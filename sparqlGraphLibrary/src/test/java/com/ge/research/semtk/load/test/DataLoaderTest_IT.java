...
public class DataLoaderTest_IT {
	...
	public void testLoadData() throws Exception {
		...
		this.queryAndCheckResults(sgJson.getNodeGroup(), "/loadTestResults.csv");
	...
	public void testLoadDataDuraBattery() throws Exception {
		...
		this.queryAndCheckResults(sgJson.getNodeGroup(), "/loadTestDuraBatteryResults.csv");
	...
	public void testLoadLookupFailTwoFound() throws Exception {
		...
		assertEquals(20, err.getNumRows());
		assertTrue(err.toCSVString().contains("multiple URI"));
	...
	public void testLoadLookXNodes() throws Exception {
		...
		queryAndCheckResults(sgJson.getNodeGroup(), "/loadTestDuraBatteryLookXNodesResults.csv");
	}
	
	@Test
	public void testLoadConnectNodes() throws Exception {
		// PEC HERE:  test to connect a known battery to a known cell, hopefully also add battery description.
		// THIS CODE IS JUST A COPY-PASTED TEMPLATE 
		
		// Look for a battery with three cells A1, B1, C1
		// Add a fourth existing cell, D1
		// Tests lookup of two different URI's
		Dataset ds = new CSVDataset("src/test/resources/loadTestDuraBatteryFirst4Data.csv", false);
	...
	private void queryAndCheckResults(NodeGroup ng, String expectedFileName) throws Exception {
		...
		String expected = Utility.getResourceAsString(this, expectedFileName).replaceAll("\r\n", "\n");
