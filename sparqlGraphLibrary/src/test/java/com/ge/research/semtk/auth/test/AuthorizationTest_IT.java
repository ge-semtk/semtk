...
public class AuthorizationTest_IT {
	...
	public void testCheckJobOwnership() throws Exception {
		ThreadAuthenticator.authenticateThisThread("test_user1");
	
		// same owner
		try {
			AuthorizationManager.throwExceptionIfNotJobOwner("test_user1", "item");
		...
		// different owner
		try {
			AuthorizationManager.throwExceptionIfNotJobOwner("test_user2", "item");
	...
	public void testCheckAdminStatusClient() throws Exception {
		testAllStatusResultsEndpointsFail("test_user1", "test_user2");
		testAllStatusResultsEndpointsSucceed("test_user1", "test_user1");
	}
	...
	public void testCheckAdmin() throws Exception {
		...
		try {
			AuthorizationManager.throwExceptionIfNotJobOwner("test_user5", "item");
