...
public class QueryGenTest_IT {
	...
	public void constructWithBinding() throws Exception {		
		...
		SparqlGraphJson sgJson = TestGraph.getSparqlGraphJsonFromResource(this.getClass(), "animalSubPropsCatHasChildAnimal.json");
		NodeGroup ng = sgJson.getNodeGroup();
		ng.getNodeBySparqlID("Animal").setBinding("ChildAnimal");
	...
	public void testCheckNodegroup() throws Exception {	
		...
		assertEquals("Found unexpected ng.checkNOdegroup() message", null, msg);
		
		// nothing to return
		ng.unsetAllReturns();
		msg = ng.checkNodegroup(AutoGeneratedQueryTypes.QUERY_DISTINCT); 
		msg = msg == null ? "<null>" : msg;
		assertTrue("Expected 'nothing to return' ng.checkNOdegroup() message, got: " + msg, msg.contains("return"));

		// nothing to delete
		msg = ng.checkNodegroup(AutoGeneratedQueryTypes.QUERY_DELETE_WHERE);
		msg = msg == null ? "<null>" : msg;
		assertTrue("Expected 'nothing to DELETE' ng.checkNodegroup() message, got: " + msg, msg.contains("delet"));
		...
		msg = ng.checkNodegroup(AutoGeneratedQueryTypes.QUERY_DISTINCT);
		msg = msg == null ? "<null>" : msg;
		assertTrue("Expected 'GROUP BY' ng.checkNodegroup() message, got: " + msg, msg.contains("GROUP BY"));
