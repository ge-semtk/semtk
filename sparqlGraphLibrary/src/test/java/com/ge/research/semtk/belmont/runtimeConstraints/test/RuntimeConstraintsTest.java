...
public class RuntimeConstraintsTest {
	...
	private void setup() throws Exception{
		...
		// test data json setup
		JSONParser jParse = new JSONParser();
		JSONObject everything = (JSONObject) jParse.parse(testJson);
		
		// get the node group json
		nodeGroupJSON = (JSONObject) everything.get("sNodeGroup");
		JSONArray nodeList = (JSONArray) nodeGroupJSON.get("sNodeList");
		ng = new NodeGroup();
		ng.addJson(nodeList);
		
		// get the runtime constraints json
		runtimeConstraintsJSON = (JSONArray) everything.get("RuntimeConstraints");
