...
public abstract class AsynchronousNodeGroupBasedQueryDispatcher {
	...
	public AsynchronousNodeGroupBasedQueryDispatcher(String jobId, SparqlGraphJson sgJson, ResultsClient rClient, StatusClient sClient, SparqlQueryClient queryClient, boolean unusedFlag, OntologyInfoClient oInfoClient) throws Exception{
		this.jobID = jobId;
