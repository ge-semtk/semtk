...
public class DispatchRestClient extends RestClient{
	...
	public SimpleResultSet executeQuery(SparqlGraphJson sgjson, AutoGeneratedQueryTypes qt, SparqlResultTypes rt, JSONObject externalConstraints, QueryFlags flags, String targetObjSparqlID) throws Exception{
		return this.executeQuery(sgjson, qt, rt, externalConstraints, flags, targetObjSparqlID, null);
	}
	...
	public SimpleResultSet executeQuery(SparqlGraphJson sgjson, AutoGeneratedQueryTypes qt, SparqlResultTypes rt, JSONObject externalConstraints, QueryFlags flags, String targetObjSparqlID, String pruneToColumn) throws Exception{
		...
		if (pruneToColumn != null) {
			this.parametersJSON.put("pruneToColumn", pruneToColumn);
		}
		...
		try{
			...
			this.parametersJSON.remove("pruneToColumn", pruneToColumn);
