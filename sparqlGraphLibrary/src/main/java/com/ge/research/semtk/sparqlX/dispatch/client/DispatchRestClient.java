...
public class DispatchRestClient extends RestClient{
	 ...
	 * @throws Exception
	 */
	public SimpleResultSet executeQuery(SparqlGraphJson sgjson, AutoGeneratedQueryTypes qt, SparqlResultTypes rt, JSONObject externalConstraints, QueryFlags flags) throws Exception{
