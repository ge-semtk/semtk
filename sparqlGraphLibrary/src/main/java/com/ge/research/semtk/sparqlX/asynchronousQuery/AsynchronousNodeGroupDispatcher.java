...
public class AsynchronousNodeGroupDispatcher extends AsynchronousNodeGroupBasedQueryDispatcher {
	 ...
	 * @throws Exception
	 */
	public AsynchronousNodeGroupDispatcher(String jobId, SparqlGraphJson sgJson, ResultsClient rClient, StatusClient sClient, SparqlQueryClient queryClient, boolean unusedFlag, OntologyInfoClient oInfoClient) throws Exception{
		super(jobId, sgJson, rClient, sClient, queryClient, unusedFlag, oInfoClient);
