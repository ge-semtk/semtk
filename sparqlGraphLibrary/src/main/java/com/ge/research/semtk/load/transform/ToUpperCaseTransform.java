...
public class ToUpperCaseTransform extends Transform {

	private final static String name = "toUpperCase";

	public ToUpperCaseTransform(String InstanceName) {
		super(InstanceName);	
	}
	
	public ToUpperCaseTransform(String instanceName, HashMap<String, String> args){
		super(instanceName, args);
	}
	
	@Override
	public String applyTransform(String input) {
		String retval = input.toUpperCase();
		return retval;
	}
