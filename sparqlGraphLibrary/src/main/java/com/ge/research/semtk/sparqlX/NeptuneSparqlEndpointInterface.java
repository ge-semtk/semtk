...
public class NeptuneSparqlEndpointInterface extends SparqlEndpointInterface {
	 ...
	 * Constructor
	 */
	public NeptuneSparqlEndpointInterface(String server, String dataset)	throws Exception {
	 ...
	 */
	public NeptuneSparqlEndpointInterface(String server, String dataset, String user, String pass)	throws Exception {
	...
	public SparqlEndpointInterface copy() throws Exception {
		...
		retval = new NeptuneSparqlEndpointInterface(this.getServerAndPort(), this.dataset, this.userName, this.password);
