...
public class NodeGroupExecutor {
	...
	public void dispatchJob(AutoGeneratedQueryTypes qt, SparqlConnection sc, NodeGroup ng, JSONObject externalConstraints, JSONArray runtimeConstraints, String targetObjectSparqlID) throws Exception{
	...
	public void dispatchJob(AutoGeneratedQueryTypes qt, SparqlConnection sc, NodeGroup ng, JSONObject externalConstraints, QueryFlags flags, JSONArray runtimeConstraints, int limitOverride, int offsetOverride, String targetObjectSparqlID) throws Exception{
		...
		if(qt.equals(AutoGeneratedQueryTypes.SELECT_DISTINCT)){
			simpleRes = this.dispatchClient.executeSelectQueryFromNodeGroup(sgjson, externalConstraints, flags);
		}
		else if(qt.equals(AutoGeneratedQueryTypes.COUNT)){
			simpleRes = this.dispatchClient.executeCountQueryFromNodeGroup(sgjson, externalConstraints);			
		}
			...
			simpleRes = this.dispatchClient.executeFilterQueryFromNodeGroup(sgjson, targetObjectSparqlID, externalConstraints);			
		}
		else if(qt.equals(AutoGeneratedQueryTypes.DELETE)){
			simpleRes = this.dispatchClient.executeDeleteQueryFromNodeGroup(sgjson, externalConstraints);			
		}	
		else if(qt.equals(AutoGeneratedQueryTypes.CONSTRUCT)){
			simpleRes = this.dispatchClient.executeConstructQueryFromNodeGroup(sgjson, externalConstraints);
		}
		else{
			throw new Exception("NodeGroupExecutor:dispatchJob :: AutoGeneratedQueryTypes type " + qt.name() + " is not currently supported.");
		}
	...
	public void dispatchJob(AutoGeneratedQueryTypes qt, SparqlConnection sc, String storedNodeGroupId, JSONObject externalConstraints, JSONArray runtimeConstraints, String targetObjectSparqlID) throws Exception{
	 ...
	 * @throws Exception
	 */
	public void dispatchJob(AutoGeneratedQueryTypes qt, SparqlConnection sc, String storedNodeGroupId, JSONObject externalConstraints, QueryFlags flags, JSONArray runtimeConstraints, int limitOverride, int offsetOverride, String targetObjectSparqlID) throws Exception{
	...
	public URL[] dispatchJobSynchronous(AutoGeneratedQueryTypes qt, SparqlConnection sc, String storedNodeGroupId, JSONObject externalConstraints, JSONArray runtimeConstraints, String targetObjectSparqlID) throws Exception {
	...
	public URL[] dispatchJobSynchronous(AutoGeneratedQueryTypes qt, SparqlConnection sc, String storedNodeGroupId, JSONObject externalConstraints, QueryFlags flags, JSONArray runtimeConstraints, int limitOverride, int offsetOverride, String targetObjectSparqlID) throws Exception {
	...
	public URL[] dispatchJobSynchronous(AutoGeneratedQueryTypes qt, SparqlConnection sc, NodeGroup ng, JSONObject externalConstraints, JSONArray runtimeConstraints, String targetObjectSparqlID) throws Exception {
		return this.dispatchJobSynchronous(qt, sc, ng, externalConstraints, null, runtimeConstraints, -1, -1, targetObjectSparqlID);
	}
	
	public URL[] dispatchJobSynchronous(AutoGeneratedQueryTypes qt, SparqlConnection sc, NodeGroup ng, JSONObject externalConstraints, QueryFlags flags, JSONArray runtimeConstraints, int limitOverride, int offsetOverride, String targetObjectSparqlID) throws Exception {
