...
public class NodeGroupExecutor {
	...
	public Table selectToTableById(SparqlConnection conn, String nodegroupId) throws Exception {
		// dispatch the job
		this.dispatchJob(AutoGeneratedQueryTypes.SELECT_DISTINCT, SparqlResultTypes.TABLE, 
				conn, nodegroupId, 
