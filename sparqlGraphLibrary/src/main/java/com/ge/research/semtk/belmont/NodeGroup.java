...
public class NodeGroup {
	...
	private QueryReturnTypes returnTypeOverride = null;
	...
	public AutoGeneratedQueryTypes getQueryType() {
		return this.queryType != null ? this.queryType : AutoGeneratedQueryTypes.QUERY_DISTINCT;
	}
	 ...
	 * @return enum or null
	 */
	public QueryReturnTypes getReturnTypeOverride() {
		return returnTypeOverride;
	}

	public void setReturnTypeOverride(QueryReturnTypes returnTypeOverride) {
	...
	public void addJsonEncodedNodeGroup(JSONObject jobj, OntologyInfo uncompressOInfo) throws Exception {
		...
		if (jobj.containsKey("returnTypeOverride")) {
			this.setReturnTypeOverride(QueryReturnTypes.getMatchingValue((String) jobj.get("returnTypeOverride")));
		}
