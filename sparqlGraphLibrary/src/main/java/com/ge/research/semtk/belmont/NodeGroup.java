...
public class NodeGroup {
	...
	public String generateSparql(AutoGeneratedQueryTypes qt, Boolean allPropertiesOptional, Integer limitOverride, Returnable targetObj, Boolean keepTargetConstraints) throws Exception{
		...
		if (qt == AutoGeneratedQueryTypes.ASK)  
			return this.generateSparqlAsk();
		else if (qt == AutoGeneratedQueryTypes.DELETE)
	...
	public String generateSparqlAsk() throws Exception {
		...
		String retval = this.generateSparqlPrefix() + "ask  " + SparqlToXLibUtil.generateSparqlFromOrUsing(tab, "FROM", this.conn, this.oInfo) +   "\n{\n" + footer + "\n}";
