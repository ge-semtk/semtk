...
public class AsyncLoadTrackThread extends Thread {
	...
	private FileSystemConnector trackBucket = null;
	private SparqlEndpointInterface sei = null;
	private String fileName = null;
	
	
	public AsyncLoadTrackThread(JobTracker jobTracker, String jobId, LoadTracker loadTracker, FileSystemConnector trackBucket, String fileKey, String fileName, SparqlEndpointInterface sei, byte[] content) {
