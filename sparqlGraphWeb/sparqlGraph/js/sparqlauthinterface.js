...
function SPARQLAuthInterface(servletDirURL, sparqlServerURL, sparqlServerType, sparqlDataset) {
...
SPARQLAuthInterface.prototype = {
  ...
  runSparqlAuthServlet : function(query, successCallback, failureCallback, statusCallback) { 
    ...
    "&sparqlDataset="    + encodeURIComponent(this.sparqlDataset) +
  ...
  runSparqlAuthServletPost : function(query, successCallback, failureCallback, statusCallback) { 
	    ...
	    $.ajax({url: url,
	      type: 'POST',
	      dataType: "json",
	      data	 : { "sparqlQuery" : query, "sparqlDataset" : this.sparqlDataset, "sparqlServerType" :  this.sparqlServerType, "sparqlServerURL" : this.sparqlServerURL},
	      success: function (x) {
	        th.callbackSPARQLAuthQuerySuccess(x);
	      },
	      failure: function (x) {
