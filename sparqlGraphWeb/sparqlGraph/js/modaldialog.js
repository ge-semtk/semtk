...
ModalDialog.prototype = {
	...
	textFieldDialog : function (title, buttonLabel, nameArray, valArray, callback, width) {
		...
		html += '<button class="btn btn" type="button" onclick="' + this.varName + '.textDialogCancel();">Cancel</button>\n';
	...
	listDialog : function (title, buttonLabel, nameArray, valArray, defaultIndex, callback, width) {
		...
		html += '<button class="btn            " type="button" onclick="' + this.varName + '.listDialogClear();">Clear</button>\n';
		html += '<button class="btn            " type="button" onclick="' + this.varName + '.listDialogCancel();">Cancel</button>\n';
		html += '<button class="btn btn-primary" type="submit">' + buttonLabel + '</button>\n';
