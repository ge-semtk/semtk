  ...
  * ============================================ */
  ...
  IIDSBasicDataGrid.prototype = {
    ...
    getOptions: function(options) {
      ...
      if (options.bStateSave) {
          //TODO: remove this when we upgrade to datatables 1.10, which fixes the XSS bug in state save.
          throw new Error("Due to a cross-site scripting vulnerability in the underlying open source project, the 'bStateSave' option is not allowed until a later version.");
      }
