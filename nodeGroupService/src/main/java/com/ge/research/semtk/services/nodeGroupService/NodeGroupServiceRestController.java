...
public class NodeGroupServiceRestController {
	...
	public JSONObject generateSelectSparql(@RequestBody NodegroupRequest requestBody, @RequestHeader HttpHeaders headers) {
		...
		try{
			...
			String msg = ng.checkNodegroup(AutoGeneratedQueryTypes.QUERY_DISTINCT);
			retval = this.generateSuccessOutput("SELECT", query, msg);
	...
	public JSONObject generateCountAllSparql(@RequestBody NodegroupRequest requestBody, @RequestHeader HttpHeaders headers) {
		...
		try{
			...
			String msg = ng.checkNodegroup(AutoGeneratedQueryTypes.QUERY_COUNT);
			retval = this.generateSuccessOutput("COUNT_ALL", query, msg);
	...
	public JSONObject generateDeleteSparql(@RequestBody NodegroupRequest requestBody, @RequestHeader HttpHeaders headers) {
		...
		try{
			...
			String msg = ng.checkNodegroup(AutoGeneratedQueryTypes.QUERY_DELETE_WHERE);
			
			retval = this.generateSuccessOutput("DELETE", query, msg);
	...
	public JSONObject generateFilterSparql(@RequestBody NodegroupSparqlIdRequest requestBody, @RequestHeader HttpHeaders headers) {
		...
		try{
			...
			String msg = ng.checkNodegroup(AutoGeneratedQueryTypes.QUERY_CONSTRAINT);
			
			retval = this.generateSuccessOutput("FILTER", query, msg);
	...
	public JSONObject generateAskSparql(@RequestBody NodegroupRequest requestBody, @RequestHeader HttpHeaders headers) {
		...
		try{
			...
			String msg = ng.checkNodegroup(AutoGeneratedQueryTypes.QUERY_ASK);
			retval = this.generateSuccessOutput("ASK", query, msg);
	...
	public JSONObject generateConstructSparqlForInstanceManipulation(@RequestBody NodegroupRequest requestBody, @RequestHeader HttpHeaders headers) {
		...
		try{
			...
			String msg = ng.checkNodegroup(AutoGeneratedQueryTypes.QUERY_CONSTRUCT);
			
			retval = this.generateSuccessOutput("CONSTRUCT", query, msg);
	...
	private SimpleResultSet generateSuccessOutput(String queryType, String query, String msg) throws Exception {
		...
		if (msg != null) {
			retval.addResult(QUERYMESSAGELABEL, msg);
		}
